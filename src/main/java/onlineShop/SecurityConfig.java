...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private DataSource dataSource;  // 和用户相关的信息
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth
			// save memory in JVM not in database
			.inMemoryAuthentication().withUser("example@gmail.com").password("1111").authorities("ROLE_ADMIN"); 
		auth
			.jdbcAuthentication()
